                ...
                <div class="breadcrumb-content d-md-flex align-items-center pt-10">
                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Destination Full</li>
                        </ul>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="trend-item">
                                    ...
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            ...
                                            <p class="mb-0 pink"><i class="fa fa-eye mr-1"></i> 255 Visiting Places <i class="fa fa-map-marker mr-1 ml-3"></i> France.</p>
                                        </div>
                                        <div class="trend-last-main">
                                            <p class="mb-0 trend-para">A wonderful little cottage right on the seashore - perfect for exploring.</p>
                                            <div class="trend-last d-flex align-items-center justify-content-between bg-navy">
                                ...
                                <div class="trend-item">
                                    ...
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            ...
                                            <p class="mb-0 pink"><i class="fa fa-eye mr-1"></i> 852 Visiting Places <i class="fa fa-map-marker mr-1 ml-3"></i> Eygpt.</p>
                                        </div>
                                        <div class="trend-last-main">
                                            <p class="mb-0 trend-para">A wonderful little cottage right on the seashore - perfect for exploring.</p>
                                            <div class="trend-last d-flex align-items-center justify-content-between bg-navy">
