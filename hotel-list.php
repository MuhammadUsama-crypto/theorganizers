                        ...
                        <div class="list-results">
                            <div class="d-flex justify-content-between align-items-center mb-2 border-b pb-2">
                                ...
                                <div class="click-menu d-flex align-items-center justify-content-between">
                                    <div class="change-list f-active mr-2"><a href="hotel-list.php"><i class="fa fa-bars"></i></a></div>
                                    <div class="change-grid"><a href="hotel-grid.php"><i class="fa fa-th"></i></a></div>
                                </div>
                            </div>
